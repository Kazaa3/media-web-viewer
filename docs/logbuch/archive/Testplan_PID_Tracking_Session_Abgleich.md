...
## Logbuch-Eintrag: Test Suite Erweiterung und offene Punkte
- Die Test Suite für die PID-Anzeige und Prozesskontrolle von Systemtools in der App-GUI deckt zahlreiche Szenarien ab:
