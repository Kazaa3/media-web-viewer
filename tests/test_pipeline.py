...
def test_pipeline_script_exists():
    ...
    script_path = Path(__file__).parent.parent / "build_system.py"
...
def test_version_sync_test_exists():
    ...
    test_path = Path(__file__).parent / "test_version_sync.py"
...
def test_reinstall_test_exists():
    ...
    test_path = Path(__file__).parent / "test_reinstall_deb.py"
...
def test_version_sync_config_exists():
    ...
    config_path = Path(__file__).parent.parent / "VERSION_SYNC.json"
