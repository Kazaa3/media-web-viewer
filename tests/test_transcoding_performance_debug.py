...
class TestTranscodingDebugCapabilities:
    ...
    def test_06_timeout_protection(self):
        ...
        app_bottle_path = Path(__file__).parent.parent / 'web' / 'app_bottle.py'
    ...
    def test_09_logbuch_52_completeness(self):
        ...
        """
        logbuch_path = Path(__file__).parent.parent / 'logbuch' / '52_FFmpeg_Transcoding_Fix_and_Optimization.md'
