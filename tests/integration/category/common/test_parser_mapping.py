...
from src.parsers.media_parser import extract_metadata, PARSER_MAPPING
...
class TestParserMapping(unittest.TestCase):
    ...
    @patch('src.parsers.format_utils.PARSER_CONFIG')
    @patch('src.parsers.filename_parser.parse')
    @patch('src.parsers.mutagen_parser.parse')
    @patch('src.parsers.isoparser_parser.parse')
