...
class TestStartupModeDetection(unittest.TestCase):
    ...
    def test_modes_are_mutually_exclusive_in_logic(self):
        ...
        no_gui = main.is_no_gui_mode(["main.py", "--ng", "--n"])
        connectionless = main.is_connectionless_browser_mode(["main.py", "--ng", "--n"])
...
class TestSessionlessModeExecution(unittest.TestCase):
    ...
    @patch('main.db.get_db_stats')
    @patch('main.db.list_legacy_databases')
...
class TestConnectionlessBrowserMode(unittest.TestCase):
    ...
    @patch('main.db.init_db')
    @patch('main.db.get_db_stats')
    @patch('main.get_preferred_browser')
