        ...
        // --- Video.js Custom Component Definitions (ES6 Classes for Video.js 8) ---
        ...
        class AudioTrackMenuButton extends vjsMenuBtn {
            constructor(player, options) {
                super(player, options);
                this.controlText('Audio');
            }
            createMenu() {
                const menu = new vjsMenu(this.player_);
            ...
            buildCSSClass() { return "vjs-icon-audio vjs-control vjs-button vjs-menu-button"; }
        }
        videojs.registerComponent('AudioTrackMenuButton', AudioTrackMenuButton);

        class SubtitleTrackMenuButton extends vjsMenuBtn {
            constructor(player, options) {
                super(player, options);
                this.controlText('Subs');
            }
            createMenu() {
                const menu = new vjsMenu(this.player_);
            ...
            buildCSSClass() { return "vjs-icon-subtitles vjs-control vjs-button vjs-menu-button"; }
        }
        videojs.registerComponent('SubtitleTrackMenuButton', SubtitleTrackMenuButton);

        let currentAspectRatio = '16:9';
        class AspectRatioMenuButton extends vjsMenuBtn {
            constructor(player, options) {
                super(player, options);
                this.controlText('Ratio');
            }
            createMenu() {
                const menu = new vjsMenu(this.player_);
            ...
            buildCSSClass() { return "vjs-icon-spinner vjs-control vjs-button vjs-menu-button"; }
        }
        videojs.registerComponent('AspectRatioMenuButton', AspectRatioMenuButton);

        class CinemaModeButton extends vjsBtn {
            constructor(player, options) {
                super(player, options);
                this.controlText('Cinema');
            }
            handleClick() { 
            ...
            buildCSSClass() { return "vjs-icon-layout vjs-control vjs-button cinema-btn"; }
        }
        videojs.registerComponent('CinemaModeButton', CinemaModeButton);

        class VisualFXMenuButton extends vjsMenuBtn {
            constructor(player, options) {
                super(player, options);
                this.controlText('Visual FX');
            }
            createMenu() {
                const menu = new vjsMenu(this.player_);
                const fx = [
            ...
            buildCSSClass() { return "vjs-icon-circle vjs-control vjs-button vjs-menu-button"; }
        }
        videojs.registerComponent('VisualFXMenuButton', VisualFXMenuButton);
        ...
        class VlcButton extends vjsBtn {
            constructor(player, options) {
                super(player, options);
                this.controlText('VLC');
            }
            handleClick() { if(typeof switchToVLC === 'function') switchToVLC(); }
            buildCSSClass() { return "vjs-icon-share vjs-control vjs-button vlc-btn"; }
        }
        videojs.registerComponent('VlcButton', VlcButton);

        class MpvButton extends vjsBtn {
            constructor(player, options) {
                super(player, options);
                this.controlText('MPV');
            }
            handleClick() { if(currentVideoPath) if(typeof startMPV === 'function') startMPV(currentVideoPath); }
            buildCSSClass() { return "vjs-icon-circle-inner-circle vjs-control vjs-button mpv-btn"; }
        }
        videojs.registerComponent('MpvButton', MpvButton);

        class SnapshotButton extends vjsBtn {
            constructor(player, options) {
                super(player, options);
            ...
            buildCSSClass() { return "vjs-icon-photo vjs-control vjs-button snapshot-btn"; }
        }
