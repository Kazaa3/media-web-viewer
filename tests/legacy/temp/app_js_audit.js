        ...
        videojs.registerComponent('AudioTrackMenuButton', vjsMenuBtn.extend({
        ...
        videojs.registerComponent('SubtitleTrackMenuButton', vjsMenuBtn.extend({
            constructor: function() { vjsMenuBtn.apply(this, arguments); },
            createMenu: function() {
                const menu = new (videojs.getComponent('Menu'))(this.player_);
        ...
        videojs.registerComponent('AspectRatioMenuButton', vjsMenuBtn.extend({
            constructor: function() { vjsMenuBtn.apply(this, arguments); },
            createMenu: function() {
                const menu = new (videojs.getComponent('Menu'))(this.player_);
        ...
        videojs.registerComponent('CinemaModeButton', vjsBtn.extend({
        ...
        videojs.registerComponent('VisualFXMenuButton', vjsMenuBtn.extend({
            constructor: function() { vjsMenuBtn.apply(this, arguments); },
            createMenu: function() {
                const menu = new (videojs.getComponent('Menu'))(this.player_);
                const fx = [
        ...
        videojs.registerComponent('StopButton', vjsBtn.extend({
            constructor: function() { vjsBtn.apply(this, arguments); },
