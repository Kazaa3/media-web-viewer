...
class TestSessionlessFlagDetection(unittest.TestCase):
    ...
    def test_detects_no_gui_short_flag(self):
        self.assertTrue(main.is_no_gui_mode(["python", "main.py", "--ng"]))

    def test_detects_no_gui_long_flag(self):
        self.assertTrue(main.is_no_gui_mode(["python", "main.py", "--sessionless"]))

    def test_no_gui_returns_false_without_flag(self):
        self.assertFalse(main.is_no_gui_mode(["python", "main.py"]))

    def test_detects_connectionless_browser_mode(self):
        self.assertTrue(main.is_connectionless_browser_mode(["python", "main.py", "--n"]))

    def test_connectionless_browser_returns_false_without_flag(self):
        self.assertFalse(main.is_connectionless_browser_mode(["python", "main.py"]))

    def test_no_gui_and_n_are_distinct(self):
        self.assertFalse(main.is_no_gui_mode(["python", "main.py", "--n"]))
        self.assertFalse(main.is_connectionless_browser_mode(["python", "main.py", "--ng"]))
