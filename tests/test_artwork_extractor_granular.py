...
from parsers.artwork_extractor import ArtworkExtractor
...
class TestArtworkExtractorGranular:
    ...
    @patch('parsers.artwork_extractor.Path.exists', return_value=True)
    ...
    @patch('parsers.artwork_extractor.Path.exists', return_value=True)
    @patch('parsers.artwork_extractor.Path.stat')
    ...
    @patch('parsers.artwork_extractor.Path.exists', return_value=True)
    @patch('parsers.artwork_extractor.Path.stat')
    @patch('parsers.artwork_extractor.ArtworkExtractor._run_ffmpeg')
