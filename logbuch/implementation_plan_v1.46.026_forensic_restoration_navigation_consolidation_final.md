# Implementation Plan: Forensic Restoration & Navigation Consolidation (v1.46.026, Final)

## Ziel
1. Wiederherstellung fehlender Audio/Video-Medien durch Backend-Fix.
2. Konsolidierung der Level-2-Navigation auf 4 Hauptgruppen mit aktualisierten Titeln und Registry.
...
- **ui_nav_helpers.js:**
  - `categoryDefaults` aktualisieren:
    ...
    - diagnostics → tests
- **app.html:**
  - Header-Reset: Nur noch 4 Hauptkategorie-Buttons im Header anzeigen: MEDIA, MANAGEMENT, OPTIONS, DIAGNOSTICS.
...
- Im Header sind nur noch 4 Buttons sichtbar: Media, Management, Options, Diagnostics.
