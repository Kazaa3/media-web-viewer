# Implementation Plan – Hardening & Modularization
...
- **Python Version:** Moving to a strict Python 3.14.2 requirement. Ensure the environment is prepared for this.
- **Modularization:** Large blocks of JavaScript will be moved from app.html to web/js/. This will improve maintainability but requires careful verification of all imports.
- **Offline Assets:** The Python 3.14.2 installer will be downloaded and stored in the repository for offline reproducibility.
...
- **[MODIFY] video_helpers.js**
  - Consolidate engine switching and player state management.

### 4. Implement DOM 7 Debugging Suite
- **[MODIFY] debug_helpers.js**
  - Extract UI trace hooks and "Div balance" checks from app.html (around line 10053).
...
### 5. Clean up app.html
- **[MODIFY] app.html**
  - Remove extracted <script> blocks.
