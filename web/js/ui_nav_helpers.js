...
window.mwv_init_actions = {
    ...
    'films': () => { if (typeof initFilmsView === 'function') initFilmsView(); },
    'series': () => { if (typeof initSeriesView === 'function') initSeriesView(); },
    'albums': () => { if (typeof initAlbumsView === 'function') initAlbumsView(); },
    'audiobooks': () => { if (typeof initAudiobooksView === 'function') initAudiobooksView(); },
...
function switchTab(tabId, btn, callback, force = false) {
    ...
    const fragmentMap = {
        ...
        'films': { containerId: 'films-main-viewport', path: 'fragments/film_view.html' },
        'series': { containerId: 'series-main-viewport', path: 'fragments/serie_view.html' },
        'albums': { containerId: 'albums-main-viewport', path: 'fragments/album_view.html' },
        'audiobooks': { containerId: 'audiobooks-main-viewport', path: 'fragments/audiobook_view.html' },
    ...
    const tabMap = {
        ...
        'films': { shell: 'films-panel-container', viewport: 'films-main-viewport' },
        'series': { shell: 'series-panel-container', viewport: 'series-main-viewport' },
        'albums': { shell: 'albums-panel-container', viewport: 'albums-main-viewport' },
        'audiobooks': { shell: 'audiobooks-panel-container', viewport: 'audiobooks-main-viewport' },
